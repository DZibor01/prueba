...
public class ResponseDirectorioDeprecated {
	...
	public ResponseDirectorioDeprecated() {
	}

	public ResponseDirectorioDeprecated(String n_nombre, String n_telefono, String n_teleusu, int i_orden) {
