...
public class ResponseBannerComercial {
  ...
  public ResponseBannerComercial() {}

  public ResponseBannerComercial(Integer idBanner, String nombreBanner, String urlImagen, String urlEnlace,
      String estado) {
