...
* TAB_APPREPOTARJETA
*/
public class ReposicionTarjetaMD{

	private String k_reposicion;
	...
	public String getK_reposicion() {
	  return this.k_reposicion;
	}
	public void setK_reposicion(String k_reposicion) {
	  this.k_reposicion = k_reposicion;
	}
