...
public class ResponseEstadoMisAportesDeprecated {

	private String k_parame;
    private String v_alfabe;

    public ResponseEstadoMisAportesDeprecated() {
    }

    public ResponseEstadoMisAportesDeprecated(String k_parame, String v_alfabe) {
