...
public class RequestSolicitudCredito extends RequestAutenticacion{
	...
	private String referenciaHotel; // n_codreserva;
	...
	public RequestSolicitudCredito() {}
	
	public RequestSolicitudCredito(String primerApellido, String segundoApellido, String primerNombre,
			...
			String fechaSolicitud, String canal, String fechaLogueo, String ip, String referenciaHotel, 
			InformacionCredito informacionCredito, List<ReferenciaCredito> referencias) {
		super();
	...
	public String getreferenciaHotel() {
		return referenciaHotel;
	}
	public void setreferenciaHotel(String referenciaHotel) {
		this.referenciaHotel = referenciaHotel;
	}
