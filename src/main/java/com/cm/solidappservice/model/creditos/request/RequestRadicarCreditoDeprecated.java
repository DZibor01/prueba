...
public class RequestRadicarCreditoDeprecated extends RequestAutenticacion{
	...
	private String ip;
	private int v_salario;
	private int v_solicitado;
        
	public RequestRadicarCreditoDeprecated() {}

	public RequestRadicarCreditoDeprecated(String aanumnit, String k_solicitud, String identificacion, String n_apell1,
			...
			String f_logeo, String ip, int v_salario, int v_solicitado) {
	...
	public int getV_salario() {
		return v_salario;
	}

	public void setV_salario(int v_salario) {
		this.v_salario = v_salario;
	}
