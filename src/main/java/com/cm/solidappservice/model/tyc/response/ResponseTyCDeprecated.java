...
**TAB_APPTERMYCOND
*/
public class ResponseTyCDeprecated {
	...
	public ResponseTyCDeprecated() {
	}

	public ResponseTyCDeprecated(Integer k_termycond, String n_termycond, Date f_modificacion, String i_estado) {
