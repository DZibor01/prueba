...
public class ResponseTransferenciasIncompletasDeprecated {
	...
	public ResponseTransferenciasIncompletasDeprecated() {
	}

	public ResponseTransferenciasIncompletasDeprecated(String id_dispositivo, String aanumnit_o, String a_numdoc,
			Double v_valor, long k_idterc, long k_idterc_tit, String n_numcta, Date f_solici, String k_ano_mov,
			String k_sucurs_mov, String k_numdoc_mov, String k_tipdoc_mov, String n_observ) {
