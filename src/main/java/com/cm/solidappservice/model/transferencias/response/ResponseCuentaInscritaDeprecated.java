...
public class ResponseCuentaInscritaDeprecated {
	...
	public ResponseCuentaInscritaDeprecated() {
	}

	public ResponseCuentaInscritaDeprecated(String aanumnit, String nnasocia, String k_cuenta, String n_numcta,
			Date f_fecape, String i_estado, String k_idterc_tit, String k_idterc, String nnasocia_o,
			String aanumnit_o) {
	...
	public Date getF_fecape() {
		return f_fecape;
	}
	public void setF_fecape(Date f_fecape) {
		this.f_fecape = f_fecape;
	}
