...
/**
 * TAB_APPLOGINPORTALUNICO
 */
public class RegistroIngresosMD{

	private String aanumnit;
	private String i_aceptacion;
	private String f_login;

	public RegistroIngresosMD() {}
  
	public RegistroIngresosMD(String aanumnit, String i_aceptacion, String f_login) {
