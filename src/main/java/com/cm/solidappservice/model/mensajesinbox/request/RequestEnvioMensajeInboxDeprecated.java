...
public class RequestEnvioMensajeInboxDeprecated extends RequestAutenticacion{
	...
	public RequestEnvioMensajeInboxDeprecated() {
	}

	public RequestEnvioMensajeInboxDeprecated(String aanumnit, String f_inicio, String f_final,
			String n_mensaj) {
		super();
