...
public class AdelantoNominaMD{
  ...
  public AdelantoNominaMD() {}
  
  public AdelantoNominaMD(String k_transa, String aanumnit, String f_solictud, Integer v_solicitado, 
  ...
  public AdelantoNominaMD(String aanumnit, String i_estado, String n_error, String k_tipodr, String k_numdoc, String f_primcuota,
  Integer k_flujo) {
    super();
    this.aanumnit = aanumnit;
    this.i_estado = i_estado;
