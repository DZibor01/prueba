...
public class ResponseTopesDeprecated {
	...
	public ResponseTopesDeprecated() {
		
	}

	public ResponseTopesDeprecated(Date f_corte, String n_aanumnit, int v_cupo, int v_minimo, int v_maximo) {
		super();
