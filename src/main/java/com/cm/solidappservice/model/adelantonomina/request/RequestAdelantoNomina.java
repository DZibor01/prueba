...
public class RequestAdelantoNomina extends RequestAutenticacion {
 
  private String f_solictud;
  private String f_solicitud; //Deprecated  
  ...
  public RequestAdelantoNomina() {
  }

  public RequestAdelantoNomina(String f_solictud, String f_solicitud, Integer v_solicitado, Integer v_valorcre, Integer v_cupo,
      String i_estado, String n_error, Integer k_flujo, String i_aceptacion, String f_aceptacion, String ip) {
