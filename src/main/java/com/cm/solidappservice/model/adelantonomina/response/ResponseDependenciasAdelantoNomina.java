...
public class ResponseDependenciasAdelantoNomina {
	
	private String k_parame;
	private String v_alfabe;

	public ResponseDependenciasAdelantoNomina() {
	}

	public ResponseDependenciasAdelantoNomina(String k_parame, String v_alfabe) {
