package com.cm.solidappservice.model.cajamenorpte.bd;
...
public class CajaMenorPteMD {
	...
	public CajaMenorPteMD() {
	}

	public CajaMenorPteMD(String id_nova, String k_numdoc, String k_perano, String k_cencos, String n_cencos,
